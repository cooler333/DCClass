...
// !!KEEP IT A SECRET!!
#define SALT_HASH @"FvTivqTqZXDmitrysgLLx1v3P8TGRyVHaSOCoolerB1pvfm02wvGadj7RLHVaZ848RKdojXYg9iAj"
...
+ (NSString *)securedSHA256DigestHashForPIN:(NSUInteger)pinHash {
    ...
    // 2
    NSString *computedHashString = [NSString stringWithFormat:@"%@%ui%@", name, (unsigned int)pinHash, SALT_HASH];
    // 3
